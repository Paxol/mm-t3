      ...
      <div className="flex-auto w-full pb-20">
        <div className="sm:container mx-auto relative">
          <div className="flex items-center justify-end my-5 relative">
            <h1 className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-2xl font-semibold text-center text-foreground">
              {name}
            </h1>
...
export const BottomNav: FC = () => {
  ...
  return (
    <div className="flex-none flex flex-row z-40 fixed bottom-0 left-0 right-0">
      <div
        className={`transition-all mx-auto h-20 container justify-between bg-accent bottom-nav-content flex flex-row flex-grow relative space-x-3 w-full ${width}`}
...
const BottomNavItem: React.FC<{
  ...
  const classes = classNames({
    ...
    "text-muted-foreground hover:text-card-foreground": !active,
  });
